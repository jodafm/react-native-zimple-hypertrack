...
///       return tcs.task
///     }
final class TaskCompletionSource<TResult> {

  /// The underlying task.
  let task = Task<TResult>()
  ...
  /**
     ...
     */
  @discardableResult func trySet(result: TResult) -> Bool {
  ...
  /**
     ...
     */
  @discardableResult func trySet(error: Error) -> Bool {
  ...
  /**
     ...
     */
  @discardableResult func tryCancel() -> Bool {
